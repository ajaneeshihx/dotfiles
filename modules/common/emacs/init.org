...
(use-package mu4e
  ...
  ;; (set-face-attribute 'mu4e-cited-1-face nil :height 100)
  ;; (set-face-attribute 'mu4e-cited-2-face nil :height 100)
  ;; (set-face-attribute 'mu4e-cited-3-face nil :height 100)
  ;; (set-face-attribute 'mu4e-cited-4-face nil :height 100)
  ;; (set-face-attribute 'mu4e-cited-5-face nil :height 100)
  ;; (set-face-attribute 'mu4e-cited-6-face nil :height 100)
  ;; (set-face-attribute 'mu4e-cited-7-face nil :height 100) 

  ;; Show the first mail automatically
  ;; (add-hook 'mu4e-headers-mode-hook
  ;;           (lambda ()
  ;;             (when (eq mu4e-split-view 'vertical)
  ;;               (mu4e-headers-view-message))))

  ;; Set up contexts for different email accounts if needed
  ;; (setq mu4e-contexts
  ;;       `(,(make-mu4e-context
  ;;           :name "gmail"
  ...
  ;;           :vars '((user-mail-address . "ajaneesh.rajashekharaiah@ihx.in")
  ;;                  (user-full-name    . "Ajaneesh Rajashekharaiah")))))
  )
#+end_src
